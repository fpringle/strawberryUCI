...
*/
#ifndef SRC_UCI_INTERFACE_H_
#define SRC_UCI_INTERFACE_H_
...
/**
 *  A class to send and receive messages to and from the GUI using
 *  the UCI protocol.
 */
class chessInterface {
 ...
 public:
     ...
     *  \param move2
     */
    void sendBestMoveMessage(std::string move1, bool ponder = false,
     ...
     */
    void sendCopyProtectMessage(MessageTypes::CopyProtectMessage status) const;
     ...
     */
    void sendRegisterMessage(MessageTypes::RegistrationMessage status) const;
     ...
     */
    void handlePositionMessage(std::string position,
